...
// ═══════════════════════════════════════════════════════════════════════════════
//
// Domain DTOs and the central `BabelState` aggregate now live in
// `crate::service::state`. This module only retains the runtime-heavy
// `impl BabelState` methods (poll loops, paint emission, IPC handling) until a
// later wave breaks them apart further. The `pub use` below preserves the
